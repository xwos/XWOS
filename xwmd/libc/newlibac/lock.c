...
struct __lock __lock___sinit_recursive_mutex; // cppcheck-suppress [misra-c2012-8.4]
struct __lock __lock___sfp_recursive_mutex; // cppcheck-suppress [misra-c2012-8.4]
struct __lock __lock___atexit_recursive_mutex; // cppcheck-suppress [misra-c2012-8.4]
struct __lock __lock___at_quick_exit_mutex; // cppcheck-suppress [misra-c2012-8.4]
struct __lock __lock___malloc_recursive_mutex; // cppcheck-suppress [misra-c2012-8.4]
struct __lock __lock___env_recursive_mutex; // cppcheck-suppress [misra-c2012-8.4]
struct __lock __lock___tz_mutex; // cppcheck-suppress [misra-c2012-8.4]
struct __lock __lock___dd_hash_mutex; // cppcheck-suppress [misra-c2012-8.4]
struct __lock __lock___arc4random_mutex; // cppcheck-suppress [misra-c2012-8.4]
