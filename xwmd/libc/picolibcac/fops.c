...
extern xwssz_t picolibcac_fops_read_stdin(int fd, void * buf, size_t cnt);
extern xwssz_t picolibcac_fops_write_stdout(int fd, const void * data, size_t cnt);
extern xwssz_t picolibcac_fops_write_stderr(int fd, const void * data, size_t cnt);
