...
ifeq ($(XWMDCFG_ds_SOC),y)
    ...
    ifeq ($(XWMDCFG_ds_SOC_CLK),y)
        XWMO_CSRCS += soc/clock.c
    endif
    ifeq ($(XWMDCFG_ds_SOC_PWR),y)
        XWMO_CSRCS += soc/power.c
    endif
    ifeq ($(XWMDCFG_ds_SOC_GPIO),y)
        XWMO_CSRCS += soc/gpio.c
    endif
    ifeq ($(XWMDCFG_ds_SOC_DMA),y)
        XWMO_CSRCS += soc/dma.c
    endif
    ifeq ($(XWMDCFG_ds_SOC_EIRQ),y)
        XWMO_CSRCS += soc/eirq.c
    endif
    ifeq ($(XWMDCFG_ds_SOC_ERAM),y)
...
ifeq ($(XWMDCFG_ds_I2C_SLAVE),y)
    XWMO_CSRCS += i2c/slave.c
endif
ifeq ($(XWMDCFG_ds_I2C_PERPHERAL),y)
    XWMO_CSRCS += i2c/perpheral.c
endif
ifeq ($(XWMDCFG_ds_LIN),y)
    XWMO_CSRCS += lin/controller.c
endif
ifeq ($(XWMDCFG_ds_LINID),y)
    XWOS_CSRCS += lin/linid.c
endif
ifeq ($(XWMDCFG_ds_CAN),y)
    ifeq ($(XWMDCFG_ds_CAN_CONTROLLER),y)
        XWMO_CSRCS += can/controller.c
    endif
    ifeq ($(XWMDCFG_ds_CAN_TRANSCEIVER),y)
