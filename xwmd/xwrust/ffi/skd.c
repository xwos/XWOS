...
xwtm_t xwrustffi_skd_get_timetick_lc(void)
{
        return xwos_skd_get_timetick_lc();
}

xwu64_t xwrustffi_skd_get_tickcount_lc(void)
{
        return xwos_skd_get_tickcount_lc();
}

xwtm_t xwrustffi_skd_get_timestamp_lc(void)
{
        return xwos_skd_get_timestamp_lc();
}
