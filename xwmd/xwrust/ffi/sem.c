...
xwer_t xwrustffi_sem_get_max(struct xwos_sem * sem, xwssq_t * max)
{
        return xwos_sem_get_max(sem, max);
}

xwer_t xwrustffi_sem_get_value(struct xwos_sem * sem, xwssq_t * val)
{
        return xwos_sem_get_value(sem, val);
}
