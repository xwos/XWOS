 ...
 ******** ******** ********    Base Config    ******** ******** ********
 ******** ******** ******** ******** ******** ******** ******** ********/
#define XWCDCFG_CHECK_PARAMETERS                                1
...
#define XWCDCFG_ds_UART_GNR                                     0
#define XWCDCFG_ds_UART_GNR_TXQ_SIZE                            (256U)
#define XWCDCFG_ds_UART_GNR_RXQ_SIZE                            (256U)
#define XWCDCFG_ds_UART_DMA                                     1
#define XWCDCFG_ds_UART_DMA_RXQ_SIZE                            (128U)
