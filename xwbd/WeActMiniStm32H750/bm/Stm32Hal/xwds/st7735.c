...
#include "bm/Stm32Hal/CubeMX/Core/Inc/tim.h"
                                  ...
                                  xwtm_t to)
{
        ...
        xwds_gpio_reset(&stm32xwds_soc,
                        STM32XWDS_ST7735_DC_PORT,
                        STM32XWDS_ST7735_DC_PIN);
        rc = xwds_spim_xfer(st7735->spip.bus, st7735->spip.buscfgid,
                            &reg, NULL, &xfsz, to);
        if (rc < 0) {
                goto err_write_cmd;
        }
