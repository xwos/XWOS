...
#include "bm/Stm32Hal/xwds/soc.h"
...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : LedH_Pin */
  GPIO_InitStruct.Pin = LedH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(LedH_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : KeyH_Pin */
  GPIO_InitStruct.Pin = KeyH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(KeyH_GPIO_Port, &GPIO_InitStruct);
