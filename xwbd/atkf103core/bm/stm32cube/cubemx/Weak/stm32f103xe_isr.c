...
void TIM8_BRK_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
void TIM8_UP_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
void TIM8_TRG_COM_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
...
void FSMC_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
...
void TIM6_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
void TIM7_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
void DMA2_Channel1_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
void DMA2_Channel2_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
void DMA2_Channel3_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
void DMA2_Channel4_5_IRQHandler(void) __xwcc_weakalias("MX_NOOP_IRQHandler");
