...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetOutputPin(GPIOB, LED1_Pin|LED0_Pin);

  /**/
  LL_GPIO_SetOutputPin(TOUCH_SCL_GPIO_Port, TOUCH_SCL_Pin);

  /**/
  LL_GPIO_SetOutputPin(TOUCH_SDA_GPIO_Port, TOUCH_SDA_Pin);
