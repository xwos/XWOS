...
static
xwer_t MX_SDRAM_Send_Cmd(uint32_t cmd,
                         uint32_t bank,
...
void MX_SDRAM_Init(void)
{
  ...
  xwu32_t modreg = SDRAM_MODEREG_BURST_LENGTH_1 |
  ...
  HAL_SDRAM_ProgramRefreshRate(&hsdram2, SDRAM_REFRESH_RATE);
}
