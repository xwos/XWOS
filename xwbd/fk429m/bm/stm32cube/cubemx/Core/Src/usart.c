...
struct MX_UART_DriverData huart1_xwds_drvdata;
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE BEGIN USART1_MspInit 1 */
    huart1_xwds_drvdata.halhdl = &huart1;
    xwos_splk_init(&huart1_xwds_drvdata.tx.splk);
    xwos_cond_init(&huart1_xwds_drvdata.tx.cond);
    huart1_xwds_drvdata.tx.rc = -ECANCELED;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE BEGIN USART1_MspDeInit 0 */
    xwos_cond_destroy(&huart1_xwds_drvdata.tx.cond);
...
{
  stm32cube_usart1_cb_rxdma_timer(huart1_xwds_drvdata.dmauartc);
}
...
void MX_USART1_RxHalfCpltCallback(UART_HandleTypeDef * huart)
{
  ...
  if (HAL_DMA_ERROR_NONE == hdma->ErrorCode) {
    stm32cube_usart1_cb_rxdma_halfcplt(huart1_xwds_drvdata.dmauartc);
  } else {
  }
}
...
void MX_USART1_RxCpltCallback(UART_HandleTypeDef * huart)
{
  ...
  hdma = huart->hdmarx;
  if (HAL_DMA_ERROR_NONE == hdma->ErrorCode) {
    stm32cube_usart1_cb_rxdma_cplt(huart1_xwds_drvdata.dmauartc);
  } else {
  }
}
...
void MX_USART1_TxCpltCallback(UART_HandleTypeDef * huart)
{
  ...
  stm32cube_usart1_cb_txdma_cplt(huart1_xwds_drvdata.dmauartc, rc);
}
...
void MX_USART1_ErrorCallback(UART_HandleTypeDef * huart)
{
  ...
  if (HAL_UART_STATE_READY == huart->RxState) {
    stm32cube_usart1_cb_rxdma_restart(huart1_xwds_drvdata.dmauartc);
  }
}
