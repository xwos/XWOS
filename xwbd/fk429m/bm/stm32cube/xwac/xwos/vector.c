...
__soc_isr_table_qualifier struct soc_isr_table soc_isr_table __xwos_vctbl = {
        ...
        .soc = {
                ...
                [DMA1_Stream0_IRQn] = arch_isr_nop, /* isr11 */
                [DMA1_Stream1_IRQn] = arch_isr_nop, /* isr12 */
                [DMA1_Stream2_IRQn] = arch_isr_nop, /* isr13 */
                [DMA1_Stream3_IRQn] = arch_isr_nop, /* isr14 */
                [DMA1_Stream4_IRQn] = arch_isr_nop, /* isr15 */
                [DMA1_Stream5_IRQn] = arch_isr_nop, /* isr16 */
                [DMA1_Stream6_IRQn] = arch_isr_nop, /* isr17 */
                ...
                [TIM1_BRK_TIM9_IRQn] = arch_isr_nop, /* isr24 */
                ...
                [DMA1_Stream7_IRQn] = arch_isr_nop, /* isr47 */
                ...
                [DMA2_Stream0_IRQn] = arch_isr_nop, /* isr56 */
                [DMA2_Stream1_IRQn] = arch_isr_nop, /* isr57 */
                [DMA2_Stream2_IRQn] = DMA2_Stream2_IRQHandler, /* isr58 */
                [DMA2_Stream3_IRQn] = DMA2_Stream3_IRQHandler, /* isr59 */
                [DMA2_Stream4_IRQn] = arch_isr_nop, /* isr60 */
                ...
                [DMA2_Stream5_IRQn] = arch_isr_nop, /* isr68 */
