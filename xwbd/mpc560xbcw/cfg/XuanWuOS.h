...
#define XuanWuOS_CFG_COMPILER                         codewarrior
#define XuanWuOS_CFG_LDSCRIPT                         cfg/qorivva.lcf
#define XuanWuOS_CFG_MK_RULE                          e200x.cw.rule
#define XuanWuOS_CFG_ELF_MK                           e200x.cw.mk
#define XuanWuOS_CFG_XWMO_MK                          e200x.cw.xwmo.mk
#include <cfg/arch.h>
 ...
 ******** ******** ********       board       ******** ******** ********
 ******** ******** ******** ******** ******** ******** ******** ********/
#define XuanWuOS_CFG_BOARD                            mpc560xbcw
#include <cfg/board.h>
