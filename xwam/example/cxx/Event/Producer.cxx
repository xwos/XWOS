...
#include "xwam/example/cxx/Event/Consumer.hxx"
#include "xwam/example/cxx/Event/Producer.hxx"

#define EVENT_DEBUG
#define LOGTAG "Event::Producer"
#include "xwam/example/cxx/Event/Log.hxx"
...
Producer::Producer(xwstk_t stack[], xwsz_t stack_size)
    : SThd("Event::Producer",
           stack, stack_size,
           XWOS_STACK_GUARD_SIZE_DEFAULT, EVENTER_THD_PRIORITY)
{
}
...
xwstk_t Producer::sStack[EVENTER_THD_STACK_SIZE / sizeof(xwstk_t)];
