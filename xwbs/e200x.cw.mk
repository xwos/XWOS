...
%.elf %.mot: libs $(XWMD) $(XWPP) $(XWBM) $(XWEM) $(XWAM) $(XWOEM)
	$(SHOW_LD) $(LD) $(LD_ARGS) -o $@

%.bin: %.mot
	$(SHOW_MOT2BIN) mot2bin $<

clean: $(XWMD_CLEAN) $(XWPP_CLEAN) $(XWBM_CLEAN) \
...
distclean: $(XWMD_DISTCLEAN) $(XWPP_DISTCLEAN) $(XWBM_DISTCLEAN) \
