...
--[[--------
从文件系统中读取脚本文件**file**，然后新建一个线程运行脚本<br>
<br>

@tparam string file (**in**) lua脚本文件的路径<br>
<br>
...
--------
-- 建立一个新的线程执行字符串**str**<br>
-- <br>
--
-- @tparam string str (**in**) 字符串<br>
-- <br>
--
-- @treturn userdata 新的线程对象的强指针 `thdsp`
--
...
--------
-- 建立一个新的线程调用函数**func**<br>
-- <br>
--
-- @tparam function func (**in**) 函数<br>
-- <br>
--
-- @treturn userdata 新的线程对象的强指针 `thdsp`
--
