                           ...
                           const enum xwaop_memory_order_em mo)
{
        ...
        case xwaop_mo_acquire:
                v = (xws8_t)armv8a_load_acquire_8b((atomic_xwu8_t *)a);
                break;
                            ...
                            xws8_t v)
{
        ...
        case xwaop_mo_acquire:
                *a = v;
                break;
        case xwaop_mo_release:
                armv8a_store_release_8b((atomic_xwu8_t *)a, (xwu8_t)v);
                break;
        case xwaop_mo_acq_rel:
                armv8a_store_release_8b((atomic_xwu8_t *)a, (xwu8_t)v);
                break;
                          ...
                          xws8_t * ov)
{
        ...
        do {
                o = (xws8_t)armv8a_load_acquire_exclusively_8b((atomic_xwu8_t *)a);
        } while (armv8a_store_release_exclusively_8b((atomic_xwu8_t *)a, (xwu8_t)v));
        if (ov) {
                *ov = o;
        }
}
                                     ...
                                     xws8_t * ov)
{
        ...
        do {
                o = (xws8_t)armv8a_load_acquire_exclusively_8b((atomic_xwu8_t *)a);
                if (o == t) {
                        rc = armv8a_store_release_exclusively_8b((atomic_xwu8_t *)a, (xwu8_t)v);
                } else {
                        rc = -EACCES;
                        break;
                }
                        ...
                        xws8_t * nv, xws8_t * ov)
{
        ...
        do {
                o = (xws8_t)armv8a_load_acquire_exclusively_8b((atomic_xwu8_t *)a);
                n = o + v;
        } while (armv8a_store_release_exclusively_8b((atomic_xwu8_t *)a, (xwu8_t)n));
        if (nv) {
                *nv = n;
        }
        if (ov) {
                                   ...
                                   xws8_t * nv, xws8_t * ov)
{
        ...
        do {
                ...
                if (o == t) {
                        n = o + v;
                        rc = armv8a_store_release_exclusively_8b((atomic_xwu8_t *)a, (xwu8_t)n);
                } else {
                        rc = -EACCES;
                        n = o;
                        break;
