...
#ifndef __xwcd_soc_arm_v8a_compiler_llvm_h__
#define __xwcd_soc_arm_v8a_compiler_llvm_h__
...
#define __xwcc_caller(x) __builtin_return_address(x)
#define __xwcc_frame(x) __builtin_frame_address(x)
...
#endif /* xwcd/soc/arm64/v8a/compiler/llvm.h */
