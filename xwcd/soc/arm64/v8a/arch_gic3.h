...
/******** ICC_SGI1R ********/
#define ARMV8A_ICC_SGI1R_TARGET_LIST_SHIFT     0UL
#define ARMV8A_ICC_SGI1R_TARGET_LIST_MASK      (0xFFFFUL << ICC_SGI1R_TARGET_LIST_SHIFT)
#define ARMV8A_ICC_SGI1R_AFFINITY_1_SHIFT      16UL
#define ARMV8A_ICC_SGI1R_AFFINITY_1_MASK       (0xFFUL << ICC_SGI1R_AFFINITY_1_SHIFT)
#define ARMV8A_ICC_SGI1R_SGI_ID_SHIFT          24UL
#define ARMV8A_ICC_SGI1R_SGI_ID_MASK           (0xfUL << ICC_SGI1R_SGI_ID_SHIFT)
#define ARMV8A_ICC_SGI1R_AFFINITY_2_SHIFT      32UL
#define ARMV8A_ICC_SGI1R_AFFINITY_2_MASK       (0xFFUL << ICC_SGI1R_AFFINITY_2_SHIFT)
#define ARMV8A_ICC_SGI1R_IRQ_ROUTING_MODE_BIT  40UL
#define ARMV8A_ICC_SGI1R_RS_SHIFT              44UL
#define ARMV8A_ICC_SGI1R_RS_MASK               (0xFUL << ICC_SGI1R_RS_SHIFT)
#define ARMV8A_ICC_SGI1R_AFFINITY_3_SHIFT      48UL
#define ARMV8A_ICC_SGI1R_AFFINITY_3_MASK       (0xFFUL << ICC_SGI1R_AFFINITY_3_SHIFT)
