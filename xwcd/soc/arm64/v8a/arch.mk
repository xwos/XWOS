...
ifeq ($(ARCHCFG_LIB_XWAOP8),y)
  ARCH_CSRCS += xwosimpl_arch_xwaop/s8.c
  ARCH_CSRCS += xwosimpl_arch_xwaop/u8.c
endif
ifeq ($(ARCHCFG_LIB_XWAOP16),y)
  ARCH_CSRCS += xwosimpl_arch_xwaop/s16.c
  ARCH_CSRCS += xwosimpl_arch_xwaop/u16.c
endif
...
ifeq ($(ARCHCFG_LIB_XWAOP64),y)
  ARCH_CSRCS += xwosimpl_arch_xwaop/s64.c
  ARCH_CSRCS += xwosimpl_arch_xwaop/u64.c
endif
