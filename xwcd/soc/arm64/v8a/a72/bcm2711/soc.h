...
#define SOC_DMA3_REGBASE (SOC_DMA_REGBASE + 0x300UL)
#define SOC_DMA4_REGBASE (SOC_DMA_REGBASE + 0x400UL)
#define SOC_DMA5_REGBASE (SOC_DMA_REGBASE + 0x500UL)
#define SOC_DMA6_REGBASE (SOC_DMA_REGBASE + 0x600UL)
#define SOC_DMA7_REGBASE (SOC_DMA_REGBASE + 0x700UL)
#define SOC_DMA8_REGBASE (SOC_DMA_REGBASE + 0x800UL)
#define SOC_DMA9_REGBASE (SOC_DMA_REGBASE + 0x900UL)
#define SOC_DMA10_REGBASE (SOC_DMA_REGBASE + 0xA00UL)
#define SOC_DMA11_REGBASE (SOC_DMA_REGBASE + 0xB00UL)
#define SOC_DMA12_REGBASE (SOC_DMA_REGBASE + 0xC00UL)
#define SOC_DMA13_REGBASE (SOC_DMA_REGBASE + 0xD00UL)
#define SOC_DMA14_REGBASE (SOC_DMA_REGBASE + 0xE00UL)
#define SOC_DMA15_REGBASE (SOC_MAIN_PERI_BASE + 0x02E05000UL)
