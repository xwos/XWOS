...
extern xwu8_t ppc_emb_sdata0_lma_base[];
extern xwu8_t ppc_emb_sdata0_vma_base[];
extern xwu8_t ppc_emb_sdata0_vma_end[];

extern xwu8_t ppc_emb_sbss0_vma_base[];
extern xwu8_t ppc_emb_sbss0_vma_end[];
...
void arch_relocate(void)
{
        ...
        src = ppc_emb_sdata0_lma_base;
        if (ppc_emb_sdata0_vma_base != src) {
                dst = ppc_emb_sdata0_vma_base;
                count = (xwsz_t)ppc_emb_sdata0_vma_end -
                        (xwsz_t)ppc_emb_sdata0_vma_base;
                for (i = 0; i < count; i++) {
                        *dst = *src;
                        dst++;
                        src++;
        ...
        dst = ppc_emb_sbss0_vma_base;
        count = (xwsz_t)ppc_emb_sbss0_vma_end - (xwsz_t)ppc_emb_sbss0_vma_base;
        for (i = 0; i < count; i++) {
                *dst = 0;
                dst++;
        }
