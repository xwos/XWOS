 ...
 ******** ******** ********      macros       ******** ******** ********
 ******** ******** ******** ******** ******** ******** ******** ********/
#define SOC_IRQC_MAX_PRIO       (0xFU) /* 0b1111 Use the MSb as IRQ switch */
#define SOC_IRQC_OS_PRIO        (0x8U) /* 0b1000 */
#define SOC_IRQC_MIN_PRIO       (SOC_IRQC_OS_PRIO + 1U)
#define SOC_IRQC_ENBIT          (3U) /* BIT(3) of priority is the enable BIT. */
...
#define SOC_SCHED_SWI_CH        1
#define SOC_SCHED_SWI_IRQN      IRQ_SWINT1
#define SOC_SCHED_SWI_PRIO      (SOC_IRQC_OS_PRIO)
#define SOC_SCHED_SWI_VALUE     0x00020000U /* SSI1 */
