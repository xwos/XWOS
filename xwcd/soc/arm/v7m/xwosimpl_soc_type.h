...
typedef uint32_t xwptr_t; /**< 指针数值 */

#define ARCH_HAVE_XWREG_T       1
typedef uint32_t xwreg_t; /**< 寄存器数值 (无符号) */

#define ARCH_HAVE_XWSREG_T      1
typedef int32_t xwsreg_t; /**< 寄存器数值 (有符号) */

#define ARCH_HAVE_XWSQ_T        1
typedef uint32_t xwsq_t; /**< 顺序值 (无符号) */

#define ARCH_HAVE_XWSSQ_T       1
typedef int32_t xwssq_t; /**< 顺序值 (有符号) */

#define ARCH_HAVE_XWID_T        1
typedef uint32_t xwid_t; /**< ID (无符号) */

#define ARCH_HAVE_XWSID_T       1
typedef int32_t xwsid_t; /**< ID (有符号) */

#define ARCH_HAVE_XWISR_F       1
typedef void (* xwisr_f)(void); /**< 中断向量 */

#define ARCH_HAVE_XWIRQ_T       1
typedef int32_t xwirq_t; /**< 中断号 (有符号) */
