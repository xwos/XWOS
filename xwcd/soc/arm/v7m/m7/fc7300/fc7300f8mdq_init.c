...
#define SCM_CPU2ECCEN_OFFSET                    0x0038U
#define SCM_CPU3ECCEN_OFFSET                    0x0130U
...
#define STCU_SRAM_INI_SEL_SRAM0_0               (1U << 0U)
#define STCU_SRAM_INI_SEL_SRAM0_1               (1U << 1U)
#define STCU_SRAM_INI_SEL_SRAM1_0               (1U << 2U)
#define STCU_SRAM_INI_SEL_SRAM1_1               (1U << 3U)
#define STCU_SRAM_INI_SEL_SRAM2_0               (1U << 4U)
#define STCU_SRAM_INI_SEL_SRAM2_1               (1U << 5U)
#define STCU_SRAM_INI_SEL_SRAM2_2               (1U << 6U)
#define STCU_SRAM_INI_SEL_ITCM_CPU0             (1U << 7U)
#define STCU_SRAM_INI_SEL_DTCM0_CPU0            (1U << 8U)
#define STCU_SRAM_INI_SEL_DTCM1_CPU0            (1U << 9U)
#define STCU_SRAM_INI_SEL_ITCM_CPU1             (1U << 10U)
#define STCU_SRAM_INI_SEL_DTCM0_CPU1            (1U << 11U)
#define STCU_SRAM_INI_SEL_DTCM1_CPU1            (1U << 12U)
#define STCU_SRAM_INI_SEL_ITCM_CPU2             (1U << 13U)
#define STCU_SRAM_INI_SEL_DTCM0_CPU2            (1U << 14U)
#define STCU_SRAM_INI_SEL_DTCM1_CPU2            (1U << 15U)
#define STCU_SRAM_INI_SEL_ITCM_CPU3             (1U << 16U)
#define STCU_SRAM_INI_SEL_DTCM0_CPU3            (1U << 17U)
#define STCU_SRAM_INI_SEL_DTCM1_CPU3            (1U << 18U)
...
#define STCU_SRAM_INI_DONE_STATUS_SRAM0_0       (1U << 0U)
#define STCU_SRAM_INI_DONE_STATUS_SRAM0_1       (1U << 1U)
#define STCU_SRAM_INI_DONE_STATUS_SRAM1_0       (1U << 2U)
#define STCU_SRAM_INI_DONE_STATUS_SRAM1_1       (1U << 3U)
#define STCU_SRAM_INI_DONE_STATUS_SRAM2_0       (1U << 4U)
#define STCU_SRAM_INI_DONE_STATUS_SRAM2_1       (1U << 5U)
#define STCU_SRAM_INI_DONE_STATUS_SRAM2_2       (1U << 6U)
#define STCU_SRAM_INI_DONE_STATUS_ITCM_CPU0     (1U << 7U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM0_CPU0    (1U << 8U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM1_CPU0    (1U << 9U)
#define STCU_SRAM_INI_DONE_STATUS_ITCM_CPU1     (1U << 10U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM0_CPU1    (1U << 11U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM1_CPU1    (1U << 12U)
#define STCU_SRAM_INI_DONE_STATUS_ITCM_CPU2     (1U << 13U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM0_CPU2    (1U << 14U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM1_CPU2    (1U << 15U)
#define STCU_SRAM_INI_DONE_STATUS_ITCM_CPU3     (1U << 16U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM0_CPU3    (1U << 17U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM1_CPU3    (1U << 18U)
...
void soc_enable_ecc(void)
{
        ...
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET) = 0x0FFFFFFFU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET) = 0x003FFFFFU;
        ...
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU2ECCEN_OFFSET) = 0x00000FCFU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU3ECCEN_OFFSET) = 0x00000FFFU;
        __asm__ volatile("dsb");
        __asm__ volatile("isb");
}
...
void soc_disable_ecc(void)
{
        ...
        __asm__ volatile("dsb");
        __asm__ volatile("isb");
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET) = 0x0AAAAAAAU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET) = 0x002AABAAU;
        ...
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU2ECCEN_OFFSET) = 0x00000A8AU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU3ECCEN_OFFSET) = 0x00000AAAU;
        __asm__ volatile("dsb");
        __asm__ volatile("isb");
}
