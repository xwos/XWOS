...
#define STCU_SRAM_INI_SEL_ITCM_CPU2             (1U << 10U)
#define STCU_SRAM_INI_SEL_DTCM0_CPU2            (1U << 11U)
#define STCU_SRAM_INI_SEL_DTCM1_CPU2            (1U << 12U)
...
#define STCU_SRAM_INI_DONE_STATUS_ITCM_CPU2     (1U << 10U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM0_CPU2    (1U << 11U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM1_CPU2    (1U << 12U)
...
void soc_enable_ecc(void)
{
        ...
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET) = 0x000003FFU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU0ECCEN_OFFSET) = 0x00000FFFU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU1ECCEN_OFFSET) = 0x00000FFFU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU2ECCEN_OFFSET) = 0x00000FFFU;
        __asm__ volatile("dsb");
        __asm__ volatile("isb");
}
...
void soc_disable_ecc(void)
{
        ...
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET) = 0x000003AAU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU0ECCEN_OFFSET) = 0x00000AAAU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU1ECCEN_OFFSET) = 0x00000AAAU;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU2ECCEN_OFFSET) = 0x00000AAAU;
        __asm__ volatile("dsb");
        __asm__ volatile("isb");
}
