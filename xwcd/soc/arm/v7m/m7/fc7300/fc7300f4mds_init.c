...
void soc_enable_ecc(void)
{
        ...
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET) = 0x0FFFFFFF;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET) = 0x000003FF;
...
void soc_disable_ecc(void)
{
        ...
        __asm__ volatile("dsb");
        __asm__ volatile("isb");
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET) = 0x0AAAAAAA;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET) = 0x000003AA;
