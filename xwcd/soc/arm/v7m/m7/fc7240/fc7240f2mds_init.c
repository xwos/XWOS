...
#define STCU_SRAM_INI_SEL_SRAM                  (1U << 0U)
#define STCU_SRAM_INI_SEL_ITCM_CPU0             (1U << 1U)
#define STCU_SRAM_INI_SEL_DTCM0_CPU0            (1U << 2U)
#define STCU_SRAM_INI_SEL_DTCM1_CPU0            (1U << 3U)
...
#define STCU_SRAM_INI_DONE_STATUS_SRAM          (1U << 0U)
#define STCU_SRAM_INI_DONE_STATUS_ITCM_CPU0     (1U << 1U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM0_CPU0    (1U << 2U)
#define STCU_SRAM_INI_DONE_STATUS_DTCM1_CPU0    (1U << 3U)
...
void soc_enable_ecc(void)
{
        ...
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET) = 0x03FFCF3F;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET) = 0x00003D33;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU0ECCEN_OFFSET) = 0x00000FFF;
        __asm__ volatile("dsb");
        __asm__ volatile("isb");
}
...
void soc_disable_ecc(void)
{
        ...
        __asm__ volatile("dsb");
        __asm__ volatile("isb");
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN0_OFFSET) = 0x02AA8A2A;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_MAMECCEN1_OFFSET) = 0x00002922;
        xwmb_access(xwu32_t, SCM_BASE_ADDR + SCM_CPU0ECCEN_OFFSET) = 0x00000AAA;
        __asm__ volatile("dsb");
        __asm__ volatile("isb");
}
