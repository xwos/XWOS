/**
 * @file
 * @brief 位图原子操作汇编库: xwbmpaop_t0i_then_s1i
 * @author
...
xwssq_t xwbmpaop_t0i_then_s1i(__xwcc_unused __xwcc_atomic xwbmp_t * bmp,
                              __xwcc_unused xwsq_t idx)
{
        ...
        __asm__ volatile("      orn     r3, r2, #0");           /* r3 = ~r2; */
        __asm__ volatile("      tst     r3, r1");               /* result = r3 & r1; update Z flag */
        __asm__ volatile("      ittee   ne");                   /* if (result is non-zero (Z != 1)) */
        __asm__ volatile("      orrne   r2, r1");               /* r2 |= r1; */
