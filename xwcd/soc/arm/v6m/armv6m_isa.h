...
#ifndef __xwcd_soc_arm_v6m_armv6m_isa_h__
#define __xwcd_soc_arm_v6m_armv6m_isa_h__
...
#define armv6m_scs                  (*((__xw_io struct armv6m_scs_reg *)ARMv6m_SCS_BASE))
#define armv6m_itm                  (*((__xw_io struct armv6m_itm_reg *)ARMv6m_ITM_BASE))
#define armv6m_dwt                  (*((__xw_io struct armv6m_dwt_reg *)ARMv6m_DWT_BASE))
#define armv6m_tpiu                 (*((__xw_io struct armv6m_tpiu_reg *)ARMv6m_TPI_BASE))
...
void armv6m_get_xpsr(xwu32_t * xpsr)
{
        __asm__ volatile(
        "mrs    %[__xpsr], xpsr"
        : [__xpsr] "=&r" (*xpsr)
 ...
 */
static __xwbsp_inline
void armv6m_set_xpsr(xwu32_t xpsr)
{
        __asm__ volatile(
        "msr    xpsr, %[__xpsr]"
        :
 ...
 */
static __xwbsp_inline
void armv6m_get_apsr(xwu32_t * apsr)
{
        __asm__ volatile(
        "mrs    %[__apsr], apsr"
        : [__apsr] "=&r" (*apsr)
 ...
 */
static __xwbsp_inline
void armv6m_set_apsr(xwu32_t apsr)
{
        __asm__ volatile(
        "msr    apsr, %[__apsr]"
        :
 ...
 */
static __xwbsp_inline
void armv6m_get_ipsr(xwu32_t * ipsr)
{
        __asm__ volatile(
        "mrs    %[__ipsr], ipsr"
        : [__ipsr] "=&r" (*ipsr)
 ...
 */
static __xwbsp_inline
void armv6m_set_ipsr(xwu32_t ipsr)
{
        __asm__ volatile(
        "msr    ipsr, %[__ipsr]"
        :
 ...
 */
static __xwbsp_inline
void armv6m_get_epsr(xwu32_t * epsr)
{
        __asm__ volatile(
        "mrs    %[__epsr], epsr"
        : [__epsr] "=&r" (*epsr)
 ...
 */
static __xwbsp_inline
void armv6m_set_epsr(xwu32_t epsr)
{
        __asm__ volatile(
        "msr    epsr, %[__epsr]"
        :
 ...
 */
static __xwbsp_inline
void armv6m_get_msp(xwptr_t * msp)
{
        __asm__ volatile(
        "mrs    %[__msp], msp"
        : [__msp] "=&r" (*msp)
 ...
 */
static __xwbsp_inline
void armv6m_set_msp(xwptr_t msp)
{
        __asm__ volatile(
        "msr    msp, %[__msp]"
        :
 ...
 */
static __xwbsp_inline
void armv6m_get_psp(xwptr_t * psp)
{
        __asm__ volatile(
        "mrs    %[__psp], psp"
        : [__psp] "=&r" (*psp)
 ...
 */
static __xwbsp_inline
void armv6m_set_psp(xwptr_t psp)
{
        __asm__ volatile(
        "msr    psp, %[__psp]"
        :
 ...
 */
static __xwbsp_inline
void armv6m_get_primask(xwu32_t * primask)
{
        __asm__ volatile(
 ...
 */
static __xwbsp_inline
void armv6m_set_primask(xwu32_t primask)
{
        __asm__ volatile(
 ...
 */
static __xwbsp_inline
void armv6m_get_faultmask(xwu32_t * faultmask)
{
        __asm__ volatile(
 ...
 */
static __xwbsp_inline
void armv6m_set_faultmask(xwu32_t faultmask)
{
        __asm__ volatile(
 ...
 */
static __xwbsp_inline
void armv6m_get_control(xwu32_t * control)
{
        __asm__ volatile(
 ...
 */
static __xwbsp_inline
void armv6m_set_control(xwu32_t control)
{
        __asm__ volatile(
 ...
 */
static __xwbsp_inline
void armv6m_itm_putc(xwu32_t port, const char c)
{
        if (__xwcc_likely((armv6m_itm.tcr.bit.itmena) &&
                     (armv6m_itm.ter[port >> 5].u32 & (1U << (port & 0x1FU))))) {
                while (0 == armv6m_itm.port[port].u32) {
                }
                armv6m_itm.port[port].u8 = (xwu8_t)c;
        }
}
 ...
 */
static __xwbsp_inline
xwssz_t armv6m_itm_puts(xwu32_t port, const char * s)
{
        xwssz_t i;

        i = 0;
        while (s[i]) {
                armv6m_itm_putc(port, s[i]);
                i++;
        }
        return i;
}
 ...
 */
static __xwbsp_inline
xwssz_t armv6m_itm_putns(xwu32_t port, const char * s, xwsz_t n)
{
        xwssz_t i;
...
void armv6m_reset_system(void)
{
        ...
        armv6m_scs.scb.aircr.u32  = (xwu32_t)((0x5FA << SCB_AIRCR_VECTKEY_POS) |
                                          (armv6m_scs.scb.aircr.u32 &
 ...
 */
static __xwbsp_inline
xwu32_t armv6m_ldrex(volatile void * addr)
{
        xwu32_t tmp;
 ...
 */
static __xwbsp_inline
xwer_t armv6m_strex(volatile void * addr, xwu32_t value)
{
        xwer_t rc;
 ...
 */
static __xwbsp_inline
xwu8_t armv6m_ldrexb(volatile void * addr)
{
        xwu8_t tmp;
 ...
 */
static __xwbsp_inline
xwer_t armv6m_strexb(volatile void * addr, xwu8_t value)
{
        xwer_t rc;
 ...
 */
static __xwbsp_inline
xwu16_t armv6m_ldrexh(volatile void * addr)
{
        xwu16_t tmp;
 ...
 */
static __xwbsp_inline
xwer_t armv6m_strexh(volatile void * addr, xwu16_t value)
{
        xwer_t rc;
 ...
 */
static __xwbsp_inline
void armv6m_prefetch(const volatile void * addr)
{
        __asm__ volatile(
        "pld    [%[__addr], #0]\n"
        :
 ...
 */
static __xwbsp_inline
void armv6m_sev(void)
{
        __asm__ volatile("sev");
}

#endif /* xwcd/soc/arm/v6m/armv6m_isa.h */
