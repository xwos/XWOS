...
static
xwer_t at24md_putc(struct xwds_eeprom * eeprom, xwu8_t data, xwptr_t addr, xwtm_t to);

static
xwer_t at24md_getc(struct xwds_eeprom * eeprom, xwu8_t * buf, xwptr_t addr, xwtm_t to);
