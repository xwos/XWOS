 ...
 ******** ******** ******** ******** ******** ******** ******** ********/
static __xwbsp_code
xwer_t at24mdd_check_desc(struct xwds_eeprom * eeprom);
...
static __xwbsp_code
xwer_t at24mdd_putc(struct xwds_eeprom * eeprom, xwu8_t data, xwptr_t addr,
                    xwtm_t * xwtm);

static __xwbsp_code
xwer_t at24mdd_getc(struct xwds_eeprom * eeprom, xwu8_t * buf, xwptr_t addr,
                    xwtm_t * xwtm);

static __xwbsp_code
xwer_t at24mdd_pgwrite(struct xwds_eeprom * eeprom, xwu8_t data[],
                       xwsz_t size, xwsq_t seq, xwtm_t * xwtm);

static __xwbsp_code
xwer_t at24mdd_pgread(struct xwds_eeprom * eeprom,
                      xwu8_t buf[], xwsz_t * size, xwsq_t seq,
                      xwtm_t * xwtm);

static __xwbsp_code
xwer_t at24mdd_reset(struct xwds_eeprom * eeprom, xwtm_t * xwtm);
...
/******** ******** AT24MDD driver ******** ********/
static __xwbsp_code
xwer_t at24mdd_power_on(struct xwds_eeprom * eeprom)
{
        xwer_t rc;
...
static __xwbsp_code
xwer_t at24mdd_power_off(struct xwds_eeprom * eeprom)
{
        xwer_t rc;
...
static __xwbsp_code
xwer_t at24mdd_wp_enable(struct xwds_eeprom * eeprom)
{
        xwer_t rc;
...
static __xwbsp_code
xwer_t at24mdd_wp_disable(struct xwds_eeprom * eeprom)
{
        xwer_t rc;
...
static __xwbsp_code
xwer_t at24mdd_pgwrite(struct xwds_eeprom * eeprom,
