...
/**
 * @brief XWOSAL API：从软件信号量对象指针获取其ID
...
/**
 * @brief XWOSAL API：从信号量ID获取对象的指针
 * @param smrid: (I) 信号量ID
 * @return 信号量对象的指针
 * @note
 * - 同步/异步：同步
