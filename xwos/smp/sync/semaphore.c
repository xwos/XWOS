...
/**
 * @brief XWOS API：尝试获取实时信号量，不会阻塞调用者。
 * @param smr: (I) 信号量对象的指针
 * @retval OK: OK
 * @retval -EFAULT: 空指针
 * @retval -ETYPE: 类型不匹配
...
/**
 * @brief XWOS API：获取管道信号量，若不能获取，就阻塞等待，且不可中断。
 * @param smr: (I) 信号量对象的指针
 * @return 错误码
 * @retval OK: OK
 * @retval -EFAULT: 空指针
...
/**
 * @brief XWOS API：获取实时信号量，若不能获取，就限时阻塞等待。
 * @param smr: (I) 信号量对象的指针
 * @param xwtm: 指向缓冲区的指针，此缓冲区：
 *              (I) 作为输入时，表示期望的阻塞等待时间
 *              (O) 作为输出时，返回剩余的期望时间
...
/**
 * @brief XWOS API：获取实时信号量，若不能获取，就阻塞等待，且不可中断。
 * @param smr: (I) 信号量对象的指针
 * @return 错误码
 * @retval OK: OK
 * @retval -EFAULT: 空指针
